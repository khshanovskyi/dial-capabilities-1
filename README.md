...
![agent](app_demo/d5_simple_agent/_flow.png)
...
5. Run the [d2_essay_assistant/app_gpt.py](app_demo/d2_essay_assistant/app_gpt.py) with Essay assistant app
6. Run the [agent_app.py](app_demo/d5_simple_agent/agent_app.py)
